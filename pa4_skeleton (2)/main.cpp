...
void testCaseForTable(int tableNumber, int subCase)
{
    ...
    if(subCase == 1)
        ...
        printStats(hashTable, false, false, true, true, true);
...
int main()
{
    ...
    //for(testCase=1;testCase<=67;testCase++)
    {
        ...
        /*
            ...
            HashTable* hashTable = new LinearProbingHashTable(7, stringLength);
            hashTable->togglePrintSteps();
            hashTable->add(new Magic{"Lightning", "Ball", 100, 10});
            hashTable->add(new Magic{"Fire", "Wind", 200, 20});
            hashTable->add(new Magic{"Lightning", "Storm", 300, 30});
            hashTable->add(new Magic{"Fire", "Ox", 400, 40});
            hashTable->remove("Ball");
            hashTable->print();
            Magic* magic = hashTable->get("Rain");
            ...
            hashTable->togglePrintSteps();
            cout << "Add: " << hashTable->add(new Magic{"Lightning", "Ball", 100, 40}) << endl;
            cout << "Add: " << hashTable->add(new Magic{"Lightning", "Cow", 200, 30}) << endl;
            cout << "Add: " << hashTable->add(new Magic{"Ice", "Ant", 300, 20}) << endl;
            cout << "Add: " << hashTable->add(new Magic{"Fire", "Rock", 400, 10}) << endl;
            cout << "Remove: " << hashTable->remove("Qw") << endl;
            cout << "Remove: " << hashTable->remove("Qw") << endl;
            cout << "Remove: " << hashTable->remove("Ball") << endl;
            cout << "Remove: " << hashTable->remove("dhjrhsdfsa") << endl;
            cout << "Remove: " << hashTable->remove("Rock") << endl;
            cout << "Remove: " << hashTable->remove("Rock") << endl;
            cout << "Remove: " << hashTable->remove("Rock") << endl;
            cout << "Remove: " << hashTable->remove("Cow") << endl;
            cout << "Remove: " << hashTable->remove("Ball") << endl;
            cout << "Remove: " << hashTable->remove("Ball") << endl;
            ...
            cout << "Sell: " << shop->sell("IceWind", 2) << endl;
            cout << "Sell: " << shop->sell("IceWind", 2) << endl;
            cout << "Sell: " << shop->sell("FireWind", 1) << endl;
            cout << "Sell: " << shop->sell("FireBall", 6) << endl;
            shop->print();
            delete shop;
        }
